...
{#if loaded}
	...
	<div class=" bg-maroon-700 dark:bg-gray-950 min-h-screen w-full flex justify-center font-primary">
		...
		<div class="w-full sm:max-w-md px-10 min-h-screen flex flex-col text-center">
			...
			<!-- <img
				src="/static/splash.png"
				class="w-max h-auto self-center"
			/> -->
			...
			{:else}
				<div class="  relative my-auto pb-10 w-full bg-gold-700 dark:text-gray-100 dark:bg-maroon-700 rounded-3xl p-[2em]">
					<form
					...
					>
						<div class="mb-1">
							<div class="absolute top-[1em] left-[1em] rounded-xl dark:bg-gold-700 aspect-square h-10 flex justify-center">
								<img
									crossorigin="anonymous"
									src="{WEBUI_BASE_URL}/static/favicon.png"
									class=" w-8 rounded-xl dark:bg-gold-700 self-center"
									alt="logo"
								/>
							</div>
							...
							<div class="mt-1 text-xs font-medium text-maroon-700 dark:text-gold-700">
								{$WEBUI_NAME}: A Lakeside School Application
							</div>
							...
							{#if mode === 'signup'}
								<div class="mb-2">
									...
									<input
										bind:value={name}
										type="text"
										class=" px-5 py-3 rounded-2xl w-full text-sm outline-none border dark:border-none dark:bg-gold-700 dark:text-gray-850 dark:placeholder-gray-850"
										autocomplete="name"
						...
						<div class="mt-5">
							<button
								class=" bg-maroon-700 hover:bg-maroon-850 dark:text-gray-850 dark:bg-gold-700 hover:dark:bg-gold-850 w-full rounded-2xl text-white font-medium text-sm py-3 transition"
								type="submit"
							>
