...
{#if !chatIdProp || (loaded && chatIdProp)}
	<div
		class="h-screen max-h-[100dvh] {$showSidebar
			...
			: ''} w-full max-w-full flex flex-col pastel:bg-sny-700"
	>
		<img
			src="/static/shield_maroon.png"
			style="position: absolute; height: calc(92% - 78px); width: auto; left: {$showSidebar ? 'calc(50% + 130px)' : '50%'}; transform: translateX(-50%); z-indexs:-999;"
			class="{showControls ? 'lg:pr-[24rem]' : ''} opacity-0 dark:opacity-30 pastel:opacity-0"
		/>
		<img
			src="/static/Black_Shield.png"
			style="position: absolute; height: calc(100% - 78px); width: auto; left: {$showSidebar ? 'calc(50% + 130px)' : '50%'}; transform: translateX(-50%); z-indexs:-999;"
			class="{showControls ? 'lg:pr-[24rem]' : ''} opacity-15 dark:opacity-0 pastel:opacity-0"
		/>	
		<img
			src="/static/yellow_Shield.png"
			style="position: absolute; height: 91%; width: auto; left: {$showSidebar ? 'calc(50% + 130px)' : '50%'}; transform: translateX(-50%); z-indexs:-999;"
			class="{showControls ? 'lg:pr-[24rem]' : ''} opacity-0 dark:opacity-0 pastel:opacity-50"
		/>		
